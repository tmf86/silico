                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Peptide</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:<?= chemin("images/Layout-4-blocks.svg") ?>-->
											<svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_pep" class="menu-link">
...
<!--														<span class="label label-danger label-inline">new</span>-->
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_pep" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
...
<!--														<span class="label label-danger label-inline">new</span>-->
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Family</span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                        <div class="menu-submenu">
                                            <i class="menu-arrow"></i>
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="?page=add_family" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">Add</span>
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="?page=list_family" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">List</span>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <a href="javascript:;" class="menu-link menu-toggle">
                                            ...
                                            <span class="menu-text">Origin</span>
                                            <i class="menu-arrow"></i>
                                        </a>
                                        <div class="menu-submenu">
                                            <i class="menu-arrow"></i>
                                            <ul class="menu-subnav">
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="?page=add_origin" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">Add</span>
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="list_origin" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Expression</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:<?= chemin("Bucket.svg") ?>-->
											<svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">Phage</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Expression</span>
												</span>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_phageExpresion" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="list_phageExpression" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Peptide Phage</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_PepPhageExpression" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=List_PepPhageExpression" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Synthetic Plate</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:<?= chemin("PenAndRuller.svg") ?>-->
											<svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">Plate Peptide</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_PlatePepSythesis" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_PlatePepSythesis" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Plate </span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_PlateSythesis" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_PlateSythesis" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Structure 3D</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:<?= chemin("Box2.svg") ?>-->
											<svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">Structure Peptide</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Peptide Structure </span>
												</span>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?pages=add_3DtSruturePep" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?pages=list_3DtSruturePep" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?pages=add_3DtSruture" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?pages=list_3DtSruture" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Evolution</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:<?= chemin("Equalizer.svg") ?>-->
											<svg xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                 viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">Bend & Graphic</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=evolution_chart" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Bend 1</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=evolution_chart1" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Bend 2</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=evolution_chart3" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Bend 3</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=evolution_chart4" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Bend 4</span>
                                        </a>
                                    </li>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text"> Peptide Target</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_PepTagets" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_PepTagets" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_Tagets" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_Tagets" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text"> Peptide Reference</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_RefPep" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_RefPep" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_Ref" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_Ref" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Keyword Peptide</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_PepKeyword" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_PepKeyword" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Keyword </span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_Keyword" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_Keyword" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text"> Biological Process</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">BioProcess Peptide</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_BioProcessPep" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_BioProcessPep" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Bio Process </span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_BioProcess" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_BioProcess" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text"> Cellule Compoments</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_PepCellComp" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_PepCellComp" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text"> Cell Compoment</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_CellComp" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_CellComp" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Molecular Function </h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_PepMolfunct" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_PepMolfunct" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Molecular Function</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu">
                                <i class="menu-arrow"></i>
                                <ul class="menu-subnav">
                                    <li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
													<span class="menu-text">Fonction Mol</span>
												</span>

                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_MolFunct" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_MolFunct" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                            ...
                            <ul class="menu-nav">
                                ...
                                <li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        <span class="menu-text">Family Recorded</span>
                                        <i class="menu-arrow"></i>
                                    </a>
                            ...
                            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                <form>
                                    ...
                                    <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                                         style="background-image: url(/metronic/theme/html/demo1/dist/assets/media/misc/bg-1.jpg)">
                                        <!--begin::Title-->
                            ...
                            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                                    <img class="h-20px w-20px rounded-sm"
                                         src="/metronic/theme/html/demo1/dist/assets/media/svg/flags/226-united-states.svg"
                                         alt=""/>
                                </div>
                            </div>
                            <!--end::Toggle-->
