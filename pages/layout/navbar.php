...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    <!--begin::Logo-->
    <a href="?page=home">
        <img alt="Silico Logo" src="<?= chemin("images/silico-2.png")?>" />
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="?page=home" class="brand-logo">
                    <img alt="Logo" class="img-fluid img-reponsive " src="<?= chemin("images/silico-23.png") ?>"  />
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
...
<!--														<span class="label label-danger label-inline">new</span>-->
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="?page=list_origin" class="menu-link">
                                                        <i class="menu-bullet menu-bullet-dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="menu-text">List</span>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=add_phageExpression" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Add</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="?page=list_phageExpression" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">List</span>
                        ...
                        <li class="menu-section">
                            <h4 class="menu-text">Synthesis Plate</h4>
                            <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                                    <img class="h-20px w-20px rounded-sm"
                                         src="public/images/226-united-states.svg"
                                         alt=""/>
                                </div>
                            </div>
                            <!--end::Toggle-->
