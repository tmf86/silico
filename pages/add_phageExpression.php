    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <!--end::Separator-->
                <!--begin::Search Form-->
                <div class="d-flex align-items-center" id="kt_subheader_search"<span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Enter Phage Expression details ands submit</span>
            </div>
            <!--end::Search Form-->
        </div>
        <!--end::Details-->
                        ...
                        <div class="wizard-steps p-8 p-lg-10">
                            <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">1. Phage Expression</h3>
                                </div>
                        ...
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form class="form" id="kt_contact_add_form">
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    <h3 class="mb-10 font-weight-bold text-dark"> Phage  Expression Details:</h3>
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-solid date" id="kt_datetimepicker_3" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-solid datetimepicker-input" name="datePhageExpression" placeholder="Select date &amp; time" data-target="#kt_datetimepicker_3" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <textarea cols="3" rows="3" class="form-control form-control-lg form-control-solid" name="descPhageExpression">

                                                    </textarea>
<!--                                                    <input class="form-control form-control-lg form-control-solid" name="descPhageExpression" type="text" value="h1g55" />-->
                                                </div>
                                            </div>
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <h6 class="font-weight-bold mb-3">Phage Expression Details:</h6>
                                    <table class="w-100">
                                        <tr>
