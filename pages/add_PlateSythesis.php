    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">New Plate Synthesis</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Enter Plate Synthesis details ands submit</span>
            </div>
            <!--end::Search Form-->
        </div>
        <!--end::Details-->
                        ...
                        <div class="wizard-steps p-8 p-lg-10">
                            <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">1. Plate Synthesis</h3>
                                </div>
                        ...
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form class="form" id="kt_contact_add_form">
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    <h3 class="mb-10 font-weight-bold text-dark"> Plate Synthesis Details:</h3>
                                    <div class="row">
                                        <div class="col-xl-12">
