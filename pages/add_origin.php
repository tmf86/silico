    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">New Origin</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                <div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-5 bg-gray-200"></div>
                <!--end::Separator-->
                <!--begin::Search Form-->
                <div class="d-flex align-items-center" id="kt_subheader_search"<span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Enter Peptides Origin details ands submit</span>
            </div>
            <!--end::Search Form-->
        </div>
        <!--end::Details-->
                        ...
                        <div class="wizard-steps p-8 p-lg-10">
                            <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                <div class="wizard-label">
                                    ...
                                    <h3 class="wizard-title">1. Origin</h3>
                                </div>
                        ...
                        <div class="col-xl-12 col-xxl-7">
                            ...
                            <form class="form" id="kt_contact_add_form">
                                ...
                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                    <h3 class="mb-10 font-weight-bold text-dark">Peptide Origin Details:</h3>
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Name Origin</label>
                                                <div class="col-lg-9 col-xl-9">
                                                    <input class="form-control form-control-lg form-control-solid" name="nameOrigin" type="text"  />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">TaxId</label>
                                                <div class="col-lg-9 col-xl-9">
                                                    <input class="form-control form-control-lg form-control-solid" name="taxid" type="text" value="1235" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Description</label>
                                                <div class="col-lg-9 col-xl-9">
                                                    <textarea cols="5" rows="6" class="form-control form-control-lg form-control-solid" name="descOrigin" >
                                ...
                                <div class="pb-5" data-wizard-type="step-content">
                                    ...
                                    <h6 class="font-weight-bold mb-3">Origin Details:</h6>
                                    <table class="w-100">
                                        <tr>
