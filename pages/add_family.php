    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">New Family</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                            ...
                            <div class="wizard-steps p-8 p-lg-10">
                                <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                    <div class="wizard-label">
                                        ...
                                        <h3 class="wizard-title">1. Family</h3>
                                    </div>
                            ...
                            <div class="col-xl-12 col-xxl-7">
                                ...
                                <form class="form" id="kt_contact_add_form">
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                        <h3 class="mb-10 font-weight-bold text-dark">Peptide Family Details:</h3>
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Alignement Family</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-lg form-control-solid" name="alignementFamily" type="text"  />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Family Name</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-lg form-control-solid" name="nameFamily" type="text" value="Enzime" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content">
                                        ...
                                        <h6 class="font-weight-bold mb-3">Family Details:</h6>
                                        <table class="w-100">
                                            <tr>
